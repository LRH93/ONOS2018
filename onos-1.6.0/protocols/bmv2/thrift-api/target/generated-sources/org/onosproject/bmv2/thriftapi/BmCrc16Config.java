...
public class BmCrc16Config implements org.apache.thrift.TBase<BmCrc16Config, BmCrc16Config._Fields>, java.io.Serializable, Cloneable, Comparable<BmCrc16Config> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("BmCrc16Config");

  private static final org.apache.thrift.protocol.TField POLYNOMIAL_FIELD_DESC = new org.apache.thrift.protocol.TField("polynomial", org.apache.thrift.protocol.TType.I16, (short)1);
  private static final org.apache.thrift.protocol.TField INITIAL_REMAINDER_FIELD_DESC = new org.apache.thrift.protocol.TField("initial_remainder", org.apache.thrift.protocol.TType.I16, (short)2);
  private static final org.apache.thrift.protocol.TField FINAL_XOR_VALUE_FIELD_DESC = new org.apache.thrift.protocol.TField("final_xor_value", org.apache.thrift.protocol.TType.I16, (short)3);
  ...
  static {
    schemes.put(StandardScheme.class, new BmCrc16ConfigStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BmCrc16ConfigTupleSchemeFactory());
  }

  public short polynomial; // required
  public short initial_remainder; // required
  public short final_xor_value; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(BmCrc16Config.class, metaDataMap);
  }

  public BmCrc16Config() {
  }
   ...
   */
  public BmCrc16Config(BmCrc16Config other) {
  ...
  public BmCrc16Config deepCopy() {
    return new BmCrc16Config(this);
  }
  ...
  public BmCrc16Config setPolynomial(short polynomial) {
    this.polynomial = polynomial;
    setPolynomialIsSet(true);
    return this;
  }
  ...
  public short getInitial_remainder() {
    return this.initial_remainder;
  }

  public BmCrc16Config setInitial_remainder(short initial_remainder) {
    this.initial_remainder = initial_remainder;
    setInitial_remainderIsSet(true);
    return this;
  }
  ...
  public short getFinal_xor_value() {
    return this.final_xor_value;
  }

  public BmCrc16Config setFinal_xor_value(short final_xor_value) {
    this.final_xor_value = final_xor_value;
    setFinal_xor_valueIsSet(true);
    return this;
  }
  ...
  public BmCrc16Config setData_reflected(boolean data_reflected) {
    this.data_reflected = data_reflected;
    setData_reflectedIsSet(true);
    return this;
  }
  ...
  public BmCrc16Config setRemainder_reflected(boolean remainder_reflected) {
    this.remainder_reflected = remainder_reflected;
    setRemainder_reflectedIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case INITIAL_REMAINDER:
      if (value == null) {
        ...
        setInitial_remainder((Short)value);
      }
      break;
    ...
    case FINAL_XOR_VALUE:
      if (value == null) {
        ...
        setFinal_xor_value((Short)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof BmCrc16Config)
      return this.equals((BmCrc16Config)that);
    return false;
  }

  public boolean equals(BmCrc16Config that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(BmCrc16Config other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("BmCrc16Config(");
    boolean first = true;
  ...
  private static class BmCrc16ConfigStandardSchemeFactory implements SchemeFactory {
    public BmCrc16ConfigStandardScheme getScheme() {
      return new BmCrc16ConfigStandardScheme();
    }
  }

  private static class BmCrc16ConfigStandardScheme extends StandardScheme<BmCrc16Config> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, BmCrc16Config struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // POLYNOMIAL
            if (schemeField.type == org.apache.thrift.protocol.TType.I16) {
              struct.polynomial = iprot.readI16();
          ...
          case 2: // INITIAL_REMAINDER
            if (schemeField.type == org.apache.thrift.protocol.TType.I16) {
              struct.initial_remainder = iprot.readI16();
          ...
          case 3: // FINAL_XOR_VALUE
            if (schemeField.type == org.apache.thrift.protocol.TType.I16) {
              struct.final_xor_value = iprot.readI16();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BmCrc16Config struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      oprot.writeFieldBegin(POLYNOMIAL_FIELD_DESC);
      oprot.writeI16(struct.polynomial);
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(INITIAL_REMAINDER_FIELD_DESC);
      oprot.writeI16(struct.initial_remainder);
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(FINAL_XOR_VALUE_FIELD_DESC);
      oprot.writeI16(struct.final_xor_value);
      oprot.writeFieldEnd();
  ...
  private static class BmCrc16ConfigTupleSchemeFactory implements SchemeFactory {
    public BmCrc16ConfigTupleScheme getScheme() {
      return new BmCrc16ConfigTupleScheme();
    }
  }

  private static class BmCrc16ConfigTupleScheme extends TupleScheme<BmCrc16Config> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, BmCrc16Config struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, BmCrc16Config struct) throws org.apache.thrift.TException {
